...
from .sinkhorn_divergence import dampening, log_weights, sinkhorn_cost, sinkhorn_loop, compute_transport_plan, plan_marginals
...
def sinkhorn_tensorized(
    ...
    **kwargs,
    ...
    #pred_unc_t = pred_unc_t.unsqueeze(-1).repeat(1, 1, N).detach()
